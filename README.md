...
1. Download or clone the GitHub repository
   ```bash
   git clone git@github.com:vaioic/OIC-267.git
   cd OIC-267
   ```
...
If you encounter any issues with running the code or have any questions, please create an [Issue](https://github.com/vaioic/OIC-267/issues) or send an email to opticalimaging@vai.org. If you are reporting a programmatic bug, please include any error messages to aid with troubleshooting.
