from analyze_images import process_images_in_dir
...
process_images_in_dir('../data/20251205 real test batch2/D30', '../processed/2026-03-13/20251205 real test batch2/D30', include_subdirs=True, additional_coords={'Day': 30}, genotype_by="dir", spacing=(1000/594), threshold=1.0)
